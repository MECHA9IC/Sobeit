...
try {
    ...
    {
        URLDownloadToFile, https://github.com/MECHA9IC/Sobeit/raw/master/API.dll?raw=true, %A_ScriptDir%\API.dll
    }
} catch() 
{
}
...
if !A_IsAdmin && !%False%
{
    if A_OSVersion not in WIN_2003,WIN_XP,WIN_2000
    {
        ...
        if (!ErrorLevel) {
            sleep 1000
            msgbox, Запустите программу от имени администратора для начала работы.
            ExitApp
        }
    }
msgbox, Запустите программу от имени администратора для начала работы.
...
FileDelete, %A_ScriptDir%\Sobeit_Updater.exe
if (A_isCompiled) {
    if (A_ScriptName != "AHK_SOBEIT_MECHANIC.exe") {
        FileMove, %A_ScriptFullPath%, %A_ScriptDir%\AHK_SOBEIT_MECHANIC.exe
        Run, %A_ScriptDir%\AHK_SOBEIT_MECHANIC.exe
        ExitApp
    }
}

Menu, Tray, NoStandard
;menu, tray, add, Проверка наличия обновлений, Update
;menu, tray, add, Связь с автором, Profile
;menu, tray, add, Сброс настроек, Delete
...
Version := "1.4"
ScriptName := "AHK SOBEIT v." Version
...
IniRead, Version, sobeit.ini, section, ScriptVersion, %ScriptVersion%
if Version != ScriptVersion
    IniDelete, sobeit.ini, section, Status
Name := getUsername()
PlayerID := getId()

Gui, Loading: color, 000000
...
Gui, Loading: Font, S6 CDefault Bold, Arial
Gui, Loading: add, Text, x5 y5 w300 h100 vLoadStatus cFFFFFF, 
Gui, Loading: Font, S7 CDefault Bold, Arial
...
Text := Text "`n*** СИНХРОНИЗАЦИЯ С SOBEIT.INI"
...
IniRead, Loaded, sobeit.ini, Other, Loaded
if (Loaded != 1) {
    sleep 500
    Text := Text "`n*** ERROR 404`n*** СОЗДАНИЕ SOBEIT.INI"
    Length4 := StrLen(Text) - Length1 - Length2 - Length3
    IniWrite, 1, sobeit.ini, Other, Loaded
    Loop, %Length4% {
...
}
{
    ...
    IniRead, Date, sobeit.ini, Other, Date, %Date%
    IniRead, CheckBox1, sobeit.ini, CheckBoxState, CheckBox1 , 1
    IniRead, CheckBox2, sobeit.ini, CheckBoxState, CheckBox2 , 0
    IniRead, CheckBox3, sobeit.ini, CheckBoxState, CheckBox3 , 1
    IniRead, CheckBox4, sobeit.ini, CheckBoxState, CheckBox4 , 1
    IniRead, CheckBox5, sobeit.ini, CheckBoxState, CheckBox5 , 1
    
    IniRead, AimVersion, sobeit.ini, Other, AimVersion , 1

    IniRead, HK1, sobeit.ini, Key, HK1, !1
    IniRead, HK2, sobeit.ini, Key, HK2, !2
    IniRead, HK3, sobeit.ini, Key, HK3, !3
    IniRead, HK4, sobeit.ini, Key, HK4, !4
    IniRead, HK5, sobeit.ini, Key, HK5, !5
    IniRead, HK6, sobeit.ini, Key, HK6, !6
    IniRead, HK7, sobeit.ini, Key, HK7, !7
    IniRead, HK8, sobeit.ini, Key, HK8, !8
    IniRead, HK9, sobeit.ini, Key, HK9, 
    IniRead, HK10, sobeit.ini, Key, HK10, 
    IniRead, HK11, sobeit.ini, Key, HK11, 
    IniRead, HK12, sobeit.ini, Key, HK12, 
    IniRead, HK13, sobeit.ini, Key, HK13, 
    IniRead, HK14, sobeit.ini, Key, HK14, 
    IniRead, HK15, sobeit.ini, Key, HK15, 
    
    IniRead, Command1, sobeit.ini, Command, Command1, %A_Space%
    IniRead, Command2, sobeit.ini, Command, Command2, %A_Space%
    IniRead, Command3, sobeit.ini, Command, Command3, %A_Space%
    IniRead, Command4, sobeit.ini, Command, Command4, %A_Space%
    IniRead, Command5, sobeit.ini, Command, Command5, %A_Space%
    IniRead, Command6, sobeit.ini, Command, Command6, %A_Space%
    IniRead, Command7, sobeit.ini, Command, Command7, %A_Space%
    IniRead, Command8, sobeit.ini, Command, Command8, %A_Space%
    IniRead, Command9, sobeit.ini, Command, Command9, %A_Space%
    IniRead, Command10, sobeit.ini, Command, Command10, %A_Space%
    IniRead, Command11, sobeit.ini, Command, Command11, %A_Space%
    IniRead, Command12, sobeit.ini, Command, Command12, %A_Space%
    IniRead, Command13, sobeit.ini, Command, Command13, %A_Space%
    IniRead, Command14, sobeit.ini, Command, Command14, %A_Space%
    IniRead, Command15, sobeit.ini, Command, Command15, %A_Space%
    
    IniRead, Mode1, sobeit.ini, Mode, Mode1, 2
    IniRead, Mode2, sobeit.ini, Mode, Mode2, 2
    IniRead, Mode3, sobeit.ini, Mode, Mode3, 2
    IniRead, Mode4, sobeit.ini, Mode, Mode4, 2
    IniRead, Mode5, sobeit.ini, Mode, Mode5, 2
    IniRead, Mode6, sobeit.ini, Mode, Mode6, 2
    IniRead, Mode7, sobeit.ini, Mode, Mode7, 2
    IniRead, Mode8, sobeit.ini, Mode, Mode8, 2
    IniRead, Mode9, sobeit.ini, Mode, Mode9, 2
    IniRead, Mode10, sobeit.ini, Mode, Mode10, 2
    IniRead, Mode11, sobeit.ini, Mode, Mode11, 2
    IniRead, Mode12, sobeit.ini, Mode, Mode12, 2
    IniRead, Mode13, sobeit.ini, Mode, Mode13, 2
    IniRead, Mode14, sobeit.ini, Mode, Mode14, 2
    IniRead, Mode15, sobeit.ini, Mode, Mode15, 2
    
    IniRead, text_hp_x, sobeit.ini, Gui_text_option, text_hp_x, 718
    IniRead, text_hp_y, sobeit.ini, Gui_text_option, text_hp_y, 90
    IniRead, text_coord_x, sobeit.ini, Gui_text_option, text_coord_x, 52 
    IniRead, text_coord_y, sobeit.ini, Gui_text_option, text_coord_y, 570
    IniRead, text_cheats_x, sobeit.ini, Gui_text_option, text_cheats_x, 180
    IniRead, text_cheats_y, sobeit.ini, Gui_text_option, text_cheats_y, 480
    IniRead, text_time_x, sobeit.ini, Gui_text_option, text_time_x, 180
    IniRead, text_time_y, sobeit.ini, Gui_text_option, text_time_y, 460
    
    IniRead, text_hp_font, sobeit.ini, Gui_text_option, text_hp_font, Verdana
    IniRead, text_hp_size, sobeit.ini, Gui_text_option, text_hp_size, 6
    IniRead, text_hp_color, sobeit.ini, Gui_text_option, text_hp_color, FFFF00
    IniRead, text_coord_font, sobeit.ini, Gui_text_option, text_coord_font, Verdana
    IniRead, text_coord_size, sobeit.ini, Gui_text_option, text_coord_size, 6
    IniRead, text_coord_color, sobeit.ini, Gui_text_option, text_coord_color, FFFFFF
    IniRead, text_cheats_font, sobeit.ini, Gui_text_option, text_cheats_font, Verdana
    IniRead, text_cheats_size, sobeit.ini, Gui_text_option, text_cheats_size, 6
    IniRead, text_time_font, sobeit.ini, Gui_text_option, text_time_font, Verdana
    IniRead, text_time_size, sobeit.ini, Gui_text_option, text_time_size, 6
    IniRead, text_time_color, sobeit.ini, Gui_text_option, text_time_color, FFFF00
    
    IniRead, FONT1, sobeit.ini, FONTS, FONT1,  Verdana
    IniRead, FONT2, sobeit.ini, FONTS, FONT2,  Arial
    IniRead, FONT3, sobeit.ini, FONTS, FONT3,  Courier New
    IniRead, FONT4, sobeit.ini, FONTS, FONT4,  Georgia
}

Text := Text "`n*** УСТАНОВКА СОЕДИНЕНИЯ С СЕРВЕРОМ"
...
InternetStatus := DllCall("Wininet\InternetCheckConnection", Str, "https://www.microsoft.com/", UInt, FLAG_ICC_FORCE_CONNECTION := 1, UInt, 0)
if (InternetStatus = 1)
    Text := Text "`n*** ПРОВЕРКА ОБНОВЛЕНИЙ"
else {
    Text := Text "`n*** ОШИБКА ПОДКЛЮЧЕНИЯ"
    sleep 500 
    ExitApp
}
...
/*
    ...
    Http.Open("GET", "https://raw.githubusercontent.com/MECHA9IC/Sobeit/master/AHK_Sobeit_Admin_List.txt")
    Http.Send(), AllAdminList := Http.ResponseText
	global REDAdminData1
	global REDAdminData2
	global 7AdminData1
	global 7AdminData2
	global 6AdminData1
	global 6AdminData2
	...
	global 1AdminData1
	global 1AdminData2
	RegExMatch(AllAdminList, ".*.RED.\s*(\d\d?)\s*(\w\w\w\w\w\w).*", REDAdminData)
	RegExMatch(AllAdminList, ".*.7.\s*(\d\d?)\s*(\w\w\w\w\w\w).*", 7AdminData)
	RegExMatch(AllAdminList, ".*.6.\s*(\d\d?)\s*(\w\w\w\w\w\w).*", 6AdminData)
	RegExMatch(AllAdminList, ".*.5.\s*(\d\d?)\s*(\w\w\w\w\w\w).*", 5AdminData)
	RegExMatch(AllAdminList, ".*.4.\s*(\d\d?)\s*(\w\w\w\w\w\w).*", 4AdminData)
	RegExMatch(AllAdminList, ".*.3.\s*(\d\d?)\s*(\w\w\w\w\w\w).*", 3AdminData)
	RegExMatch(AllAdminList, ".*.2.\s*(\d\d?)\s*(\w\w\w\w\w\w).*", 2AdminData)
	RegExMatch(AllAdminList, ".*.1.\s*(\d\d?)\s*(\w\w\w\w\w\w).*", 1AdminData)
	global AdminsAtSum := 7AdminData1 + 6AdminData1 + 5AdminData1 + 4AdminData1 + 3AdminData1 + 2AdminData1 + 1AdminData1
*/

Length6 := StrLen(Text) - Length1 - Length2 - Length3 - Length4 -  Length5
Loop, %Length6% {
    GuiControl, Loading:, Progress, +1
    LoadStatus := SubStr(Text, 1, A_Index + Length1 + Length2 + Length3 + Length4 + Length5)
    GuiControl, Loading:, LoadStatus, *** %LoadStatus%
    Sleep, 50
}
if (InternetStatus = 1) {
    Http := ComObjCreate("WinHttp.WinHttpRequest.5.1"), Http.Option(6) := 0
    Http.Open("GET", "https://raw.githubusercontent.com/MECHA9IC/Sobeit/master/Version")
    Http.Send(), Text := Http.ResponseText
    New_Version := RegExReplace(Text, "i).*?Version\s*(\d+)\s*", "$1")
    RegExMatch(New_Version, "(\d?\d?\d)\s(\d?\d.\d)\sfrom\s(\d\d.\d\d.\d\d)\s(.*).", New_Version_Info_)
    if (New_Version_Info_1 > Current_Script_Version) {
        URLDownloadToFile, https://github.com/MECHA9IC/Sobeit/raw/master/Sobeit_Updater.exe?raw=true, %A_ScriptDir%\Sobeit_Updater.exe
        sleep 100
        Run %A_ScriptDir%\Sobeit_Updater.exe
        ExitApp
        return
    }
}
...
Gui, Add, Progress, x-1 y-1 w471 h21 Background404040 Disabled hwndHPROG
Gui, Add, Text, x0 y0 w470 h20 BackgroundTrans Center 0x200 gGuiMove vCaption cFFFFFF, %ScriptName%
Gui, Font, S12 CDefault Bold, Arial

Gui, Add, Text, x470 y-3 w20 h23 cFFFFFF gGuiHide Center, _
Gui, Add, Text, x490 y0 w20 h20  cFF0000 gGuiClose Center, x

Gui, Font, S8 CDefault Bold, Arial
Gui, Add, DropDownList, x5 y23 w90 h80 vMode1 gChangeMode Choose%Mode1% AltSubmit , COMMAND|HOTKEY
if (Mode1 = 1) {
    EnableEdit1 := 1
    Gui, Add, Edit, x105 y23 w90 h20 vCommand1, %Command1%  
}
else {
    EnableHotKey1 := 1
    Gui, Add, Hotkey, x105 y23 w90 h20 vHK1 ggetKey cFFFFFF, %HK1%
}
Gui, Add, Text, x210 y25 w430 h20 BackgroundTrans cFFFFFF, - Активация\Деактивация WallHack
Gui, Add, DropDownList, x5 y44 w90 h80 vMode2 gChangeMode Choose%Mode2% AltSubmit , COMMAND|HOTKEY
if (Mode2 = 1) {
    EnableEdit2 := 1
    Gui, Add, Edit, x105 y44 w90 h20 vCommand2, %Command2%  
}
else {
    EnableHotKey2 := 1
    Gui, Add, Hotkey, x105 y44 w90 h20 vHK2 ggetKey cFFFFFF, %HK2%
}
Gui, Add, Text, x210 y46 w430 h20 BackgroundTrans cFFFFFF, - Активация\Деактивация AIM
Gui, Add, DropDownList, x390 y43 w90 h80 vAimVersion Choose%AimVersion% AltSubmit , POOR|TARGET

Gui, Add, DropDownList, x5 y65 w90 h80 vMode3 gChangeMode Choose%Mode3% AltSubmit , COMMAND|HOTKEY
if (Mode3 = 1) {
    EnableEdit3 := 1
    Gui, Add, Edit, x105 y65 w90 h20 vCommand3, %Command3%  
}
else {
    EnableHotKey3 := 1
    Gui, Add, Hotkey, x105 y65 w90 h20 vHK3 ggetKey cFFFFFF, %HK3%
}
Gui, Add, Text, x210 y67 w430 h20 BackgroundTrans cFFFFFF, - Обнулить ХП ближайшему/текущему транспорту

Gui, Add, DropDownList, x5 y86 w90 h80 vMode4 gChangeMode Choose%Mode4% AltSubmit , COMMAND|HOTKEY
if (Mode4 = 1) {
    EnableEdit4 := 1
    Gui, Add, Edit, x105 y86 w90 h20 vCommand4, %Command4%  
}
else {
    EnableHotKey4 := 1
    Gui, Add, Hotkey, x105 y86 w90 h20 vHK4 ggetKey cFFFFFF, %HK4%
}
Gui, Add, Text, x210 y88 w430 h20 BackgroundTrans cFFFFFF, - Активация\Деактивация Анти-Перезарядки
Gui, Add, DropDownList, x5 y107 w90 h80 vMode5 gChangeMode Choose%Mode5% AltSubmit , COMMAND|HOTKEY
if (Mode5 = 1) {
    EnableEdit5 := 1
    Gui, Add, Edit, x105 y107 w90 h20 vCommand5, %Command5%  
}
else {
    EnableHotKey5 := 1
    Gui, Add, Hotkey, x105 y107 w90 h20 vHK5 ggetKey cFFFFFF, %HK5%
}
Gui, Add, Text, x210 y109 w430 h20 BackgroundTrans cFFFFFF, - SpeedHack x0.1
Gui, Add, DropDownList, x5 y128 w90 h80 vMode6 gChangeMode Choose%Mode6% AltSubmit , COMMAND|HOTKEY
if (Mode6 = 1) {
    EnableEdit6 := 1
    Gui, Add, Edit, x105 y128 w90 h20 vCommand6, %Command6%  
}
else {
    EnableHotKey6 := 1
    Gui, Add, Hotkey, x105 y128 w90 h20 vHK6 ggetKey cFFFFFF, %HK6%
}
Gui, Add, Text, x210 y130 w430 h20 BackgroundTrans cFFFFFF, - Перевод авто по оси X+
Gui, Add, DropDownList, x5 y149 w90 h80 vMode7 gChangeMode Choose%Mode7% AltSubmit , COMMAND|HOTKEY
if (Mode7 = 1) {
    EnableEdit7 := 1
    Gui, Add, Edit, x105 y149 w90 h20 vCommand7, %Command7%  
}
else {
    EnableHotKey7 := 1
    Gui, Add, Hotkey, x105 y149 w90 h20 vHK7 ggetKey cFFFFFF, %HK7%
}
Gui, Add, Text, x210 y151 w430 h20 BackgroundTrans cFFFFFF, - Телепорт на +1 позицию по направлению камеры

Gui, Add, DropDownList, x5 y169 w90 h80 vMode8 gChangeMode Choose%Mode8% AltSubmit , COMMAND|HOTKEY
if (Mode8 = 1) {
    EnableEdit8 := 1
    Gui, Add, Edit, x105 y169 w90 h20 vCommand8, %Command8%  
}
else {
    EnableHotKey8 := 1
    Gui, Add, Hotkey, x105 y169 w90 h20 vHK8 ggetKey cFFFFFF, %HK8%
}
Gui, Add, Text, x210 y171 w430 h20 BackgroundTrans cFFFFFF, - Отключение Игрового Интерфейса (Game GUI)

Gui, Add, Text, x8 y200 h20 BackgroundTrans cFFFFFF, Alt+CapsLock`t      - /time
Gui, Add, Text, x8 y215 h20 BackgroundTrans cFFFFFF, B`t`t      - Быстрая остановка автомобиля
Gui, Add, Text, x8 y230 h20 BackgroundTrans cFFFFFF, M`t`t      - Турбо-режим (Уменьшение уровня сцепления с трассой, ОПАСНО!)

Gui, Add, Text, x8 y250 h20 BackgroundTrans cFFFFFF, /hp [HP]`t      - Установить уровень здоровья (Желательно не повышать xD)
Gui, Add, Text, x8 y265 h20 BackgroundTrans cFFFFFF, /kill `t`t      - Мгновенное убийство
Gui, Add, Text, x8 y280 h20 BackgroundTrans cFFFFFF, /setpos [X][Y][X]      - Телепорт в указанные координаты (Персонаж/Авто)
Gui, Add, Text, x8 y295 h20 BackgroundTrans cFFFFFF, /gr [Gravity]`t      - Установить уровень гравитации (Стандарт 0.008)
Gui, Add, Text, x8 y310 h20 BackgroundTrans cFFFFFF, /skin [id]`t      - Установить себе скин (Визуально)
Gui, Add, Text, x8 y325 h20 BackgroundTrans cFFFFFF, /object [Model] [X] [Y] [Z] [xRot] [yRot] [zRot] [drawDistance] - Создать объект (Визуально)

Gui, Add, CheckBox, x5 y345 w300 h13 Checked%CheckBox1% vCheckBox1 gEnableGUI BackgroundTrans cFFFFFF, Отображение внутриигрового интерфейса
;Gui, Add, CheckBox, x5 y360 w300 h13 Checked%CheckBox2% vCheckBox2 BackgroundTrans cFFFFFF, Отображение админ-чекера
Gui, Add, CheckBox, x5 y375 w300 h13 Checked%CheckBox3% vCheckBox3 BackgroundTrans cFFFFFF, Автоответ при проверке админа на AFK w/o Esc
Gui, add, button, x300 y357 w105 h20 gEditInGameGui, EDIT INGAME GUI
Gui, Add, Text, x410 y360 w95 h20 BackgroundTrans c00FF00 vActive cFFFFFF Right, Gta active status
Gui, Font, S6 CDefault Bold, Arial
Gui, Add, Text, x435 y385 h20 cFFFFFF, MECHANIC PROD
Gui, Font, S8 CDefault Bold, Arial
Gui, Show, w510 h400, %ScriptName%
goto Submit
...
{
    GuiControl, +cRed, Active
    GuiControl, , Active, GTA NOT EXIST
    GuiControl, Move, Active, x395
    Loop {
        Process, Exist, gta_sa.exe
...
GuiControl, +cGreen, Active
GuiControl, , Active, GTA EXIST
GuiControl, Move, Active, x400
Main3:
Gui, Submit, NoHide
DestroyAllVisual()
if (CheckBox1) {
    ...
    text_nope := TextCreate("Verdana", 6, true, false, 718, 90, 0xFFFFFF00,"", true, true)
    text_hp := TextCreate(text_hp_font, text_hp_size, true, false, text_hp_x, text_hp_y, 0xFFFFFFFF, "{FFFFFF}" HP , true, true)
    text_coord := TextCreate(text_coord_font, text_coord_size, true, false, text_coord_x, text_coord_y, 0xFFFFFFFF,  "{FFFFFF}" X " " T " " Z  " " Interior, true, true)
    if (!text_coord)
        goto Main3
    text_cheats := TextCreate(text_cheats_font, text_cheats_size, true, false, text_cheats_x, text_cheats_y, 0xFFFFFFFF,  "{FFFFFF}", true, true)
    FormatTime, TimeNow, , dd.MM.yyyy HH:mm:ss
    text_time := TextCreate(text_time_font, text_time_size, true, false, text_time_x, text_time_y, 0xFFFFFFFF,  "{FF0000}" TimeNow, true, true)
    ;text_admins := TextCreate("Verdana", 6, true, false, 700, 150, 0xFFFFFF00, "", true, true)
    Loop {
        Gui, Submit, NoHide
        AntiCrash()
        if (CheckBox3)
            AntiAdminAFKCheck(getChatLineEx(0))
        if (CheckBox1) {
            Gui, Submit, NoHide
            WH := readMem(hGTA, dwSAMP + 0x70F1A, 1, "byte")
            if (byte = 144 || tog)
                WallHackStatus := "{228B22}Enabled{FFFFFF}"
            else if(byte = 232 || !tog)
                WallHackStatus := "{FF0000}Disabled{FFFFFF}"
            NR := readMem(hGTA, 0x7428B0, 1, "byte")
            if (NR = 144)
                NoReload := "{228B22}Enabled{FFFFFF}"
            else
                NoReload := "{FF0000}Disabled{FFFFFF}"
            if (AimVersion = 1)
                AIMV := " [POOR]"
            else
                AIMV := " [TARGET]"
            if (AIM = 1)
                AIMStatus := "{228B22}Enabled{FFFFFF}" AIMV
            else
                AIMStatus := "{FF0000}Disabled{FFFFFF}" AIMV
            byte := readMem(hGTA, 0x60A5BA, 1, "byte")
            ...
            ;setFireImmunity(state)                    ; - Установить иммунитет к огню (0 - выкл, 1 - не гореть в огне) 
            ;setInfiniteRun(state)                   ; - бесконечный бег (0 выкл / 1 вкл)   
            Gear := readDWORD(hGTA, ADDR_VEHICLE_PTR + ADDR_VEHICLE_GEAR)
            Rotation := readFloat(hGTA, 0xB6F5F0 + 0x558) 
            ...
            TextSetString(text_cheats, "{FFFFFF}WallHack: " WallHackStatus "`nGravity: " GetGravity() "`nAIM: " AIMStatus "`nNoReload: " NoReload "`n" Round(getVehicleSpeed()*0.877) " " Turbo " " Round(getVehicleHealth()) "`nFPS: " getPlayerFps() ", PING: " getPlayerPingById(getId()) "`n" getPlayerZone() "`n" "Online: " hour ":" min ":" sec)
            ;if(CheckBox2) {
            ;    TextSetString(text_admins, "{FFFF00}" GetAdminList(AllAdminList))
            ;    if (Destroyed) {
            ;        text_admins := TextCreate("Verdana", 6, true, false, 700, 150, 0xFFFFFF00, "", true, true)
            ;        Destroyed := 0
            ;    }
            ...
            ;else {
            ;    Destroyed := 1
            ;    TextDestroy(text_admins)
            ; }
            Interior := getPlayerInteriorId()
            getPlayerPos(X,Y,Z)
            if (isPlayerInAnyVehicle()) {
                dwAddr := readDWORD(hGTA, ADDR_VEHICLE_PTR)
                byte := readMem(hGTA, dwAddr + 0x14, 4, "byte")
                VehX := readFloat(hGTA, byte + 0x30)
                VehY := readFloat(hGTA, byte + 0x34)
                VehZ := readFloat(hGTA, byte + 0x38)
            ...
            TextSetString(text_coord, "{" text_coord_color "}" X " " Y " " Z " " Interior "`n" VehX " " VehY " " VehZ)
            TextSetString(text_hp, "{" text_hp_color "}" getPlayerHealth())
            FormatTime, TimeNow, , dd.MM.yyyy HH:mm:ss
            TextSetString(text_time, "{" text_time_color "}" TimeNow)
            sleep 10
            Process, Exist, gta_sa.exe
            IfWinNotExist, % "ahk_pid " errorlevel
            {
...
Gui, Submit, NoHide
    {
    IniWrite, %Date%, sobeit.ini, Other, Date
    IniWrite, %CheckBox1%, sobeit.ini, CheckBoxState, CheckBox1
    IniWrite, %CheckBox2%, sobeit.ini, CheckBoxState, CheckBox2
    IniWrite, %CheckBox3%, sobeit.ini, CheckBoxState, CheckBox3
    IniWrite, %CheckBox4%, sobeit.ini, CheckBoxState, CheckBox4
    IniWrite, %CheckBox5%, sobeit.ini, CheckBoxState, CheckBox5
    IniWrite, %HK1%, sobeit.ini, Key, HK1
    IniWrite, %HK2%, sobeit.ini, Key, HK2
    IniWrite, %HK3%, sobeit.ini, Key, HK3
    IniWrite, %HK4%, sobeit.ini, Key, HK4
    IniWrite, %HK5%, sobeit.ini, Key, HK5
    IniWrite, %HK6%, sobeit.ini, Key, HK6
    IniWrite, %HK7%, sobeit.ini, Key, HK7
    IniWrite, %HK8%, sobeit.ini, Key, HK8
    IniWrite, %HK9%, sobeit.ini, Key, HK9
    IniWrite, %HK10%, sobeit.ini, Key, HK10
    IniWrite, %HK11%, sobeit.ini, Key, HK11
    IniWrite, %HK12%, sobeit.ini, Key, HK12
    IniWrite, %HK13%, sobeit.ini, Key, HK13
    IniWrite, %HK14%, sobeit.ini, Key, HK14
    IniWrite, %HK15%, sobeit.ini, Key, HK15
    IniWrite, %Command1%, sobeit.ini, Command, Command1
    IniWrite, %Command2%, sobeit.ini, Command, Command2
    IniWrite, %Command3%, sobeit.ini, Command, Command3
    IniWrite, %Command4%, sobeit.ini, Command, Command4
    IniWrite, %Command5%, sobeit.ini, Command, Command5
    IniWrite, %Command6%, sobeit.ini, Command, Command6
    IniWrite, %Command7%, sobeit.ini, Command, Command7
    IniWrite, %Command8%, sobeit.ini, Command, Command8
    IniWrite, %Command9%, sobeit.ini, Command, Command9
    IniWrite, %Command10%, sobeit.ini, Command, Command10
    IniWrite, %Command11%, sobeit.ini, Command, Command11
    IniWrite, %Command12%, sobeit.ini, Command, Command12
    IniWrite, %Command13%, sobeit.ini, Command, Command13
    IniWrite, %Command14%, sobeit.ini, Command, Command14
    IniWrite, %Command15%, sobeit.ini, Command, Command15
    IniWrite, %Mode1%, sobeit.ini, Mode, Mode1
    IniWrite, %Mode2%, sobeit.ini, Mode, Mode2
    IniWrite, %Mode3%, sobeit.ini, Mode, Mode3
    IniWrite, %Mode4%, sobeit.ini, Mode, Mode4
    IniWrite, %Mode5%, sobeit.ini, Mode, Mode5
    IniWrite, %Mode6%, sobeit.ini, Mode, Mode6
    IniWrite, %Mode7%, sobeit.ini, Mode, Mode7
    IniWrite, %Mode8%, sobeit.ini, Mode, Mode8
    IniWrite, %Mode9%, sobeit.ini, Mode, Mode9
    IniWrite, %Mode10%, sobeit.ini, Mode, Mode10
    IniWrite, %Mode11%, sobeit.ini, Mode, Mode11
    IniWrite, %Mode12%, sobeit.ini, Mode, Mode12
    IniWrite, %Mode13%, sobeit.ini, Mode, Mode13
    IniWrite, %Mode14%, sobeit.ini, Mode, Mode14
    IniWrite, %Mode15%, sobeit.ini, Mode, Mode15
    IniWrite, %AimVersion%, sobeit.ini, Other, AimVersion
    IniWrite, %text_hp_x%, sobeit.ini, Gui_text_option, text_hp_x
    IniWrite, %text_hp_y%, sobeit.ini, Gui_text_option, text_hp_y
    IniWrite, %text_coord_x%, sobeit.ini, Gui_text_option, text_coord_x
    IniWrite, %text_coord_y%, sobeit.ini, Gui_text_option, text_coord_y
    IniWrite, %text_cheats_x%, sobeit.ini, Gui_text_option, text_cheats_x
    IniWrite, %text_cheats_y%, sobeit.ini, Gui_text_option, text_cheats_y
    IniWrite, %text_time_x%, sobeit.ini, Gui_text_option, text_time_x
    IniWrite, %text_time_y%, sobeit.ini, Gui_text_option, text_time_y
    
    IniWrite, %text_hp_font%, sobeit.ini, Gui_text_option, text_hp_font
    IniWrite, %text_hp_size%, sobeit.ini, Gui_text_option, text_hp_size
    IniWrite, %text_hp_color%, sobeit.ini, Gui_text_option, text_hp_color
    IniWrite, %text_coord_font%, sobeit.ini, Gui_text_option, text_coord_font
    IniWrite, %text_coord_size%, sobeit.ini, Gui_text_option, text_coord_size
    IniWrite, %text_coord_color%, sobeit.ini, Gui_text_option, text_coord_color
    IniWrite, %text_cheats_font%, sobeit.ini, Gui_text_option, text_cheats_font
    IniWrite, %text_cheats_size%, sobeit.ini, Gui_text_option, text_cheats_size
    IniWrite, %text_time_font%, sobeit.ini, Gui_text_option, text_time_font
    IniWrite, %text_time_size%, sobeit.ini, Gui_text_option, text_time_size
    IniWrite, %text_time_color%, sobeit.ini, Gui_text_option, text_time_color
    
    IniWrite, %FONT1%, sobeit.ini, FONTS, FONT1
    IniWrite, %FONT2%, sobeit.ini, FONTS, FONT2
    IniWrite, %FONT3%, sobeit.ini, FONTS, FONT3
    IniWrite, %FONT4%, sobeit.ini, FONTS, FONT4
    }
    DestroyAllVisual()
    LoopNumber := Transparent//10
    Loop, %LoopNumber% {
...
if(isInChat() && !isDialogOpen()) {
    ...
    if(SubStr(TextChat, 1, 3) = "/gr") { ; Определено что введена команда        
        if(SubStr(TextChat, 4) = "")
            return
        Gravity := SubStr(TextChat, 5)
        addChatMessageEx(0x808080, "[SOBEIT] Gravity " Gravity)
        SetGravity(Gravity)
    }
    else if(SubStr(TextChat, 1, 3) = "/hp") { ; Определено что введена команда        
        if(SubStr(TextChat, 4) = "")
            return
        Count := SubStr(TextChat, 5)
        if (Count >= 0 && Count <= 100)
            setPlayerHealth(Count)
    }
    else if(SubStr(TextChat, 1) = "/kill") { ; Определено что введена команда        
        setPlayerHealth(0)
    }
    else if(SubStr(TextChat, 1, 7) = "/setpos") {
        if(SubStr(TextChat, 8) = "" || SubStr(TextChat, 8) = " ")
            return
        SetPos := SubStr(TextChat, 9)
        RegExMatch(SetPos, "(-?[\d.]*)\s(-?[\d.]*)\s(-?[\d.]*)", Pos)
        if (isPlayerInAnyVehicle()) {
            dwAddr := readDWORD(hGTA, ADDR_VEHICLE_PTR)
            byte := readMem(hGTA, dwAddr + 0x14, 4, "byte")
            CoordX := writeFloat(hGTA, byte + 0x30, Pos1)
            CoordY := writeFloat(hGTA, byte + 0x34, Pos2)
            CoordZ := writeFloat(hGTA, byte + 0x38, Pos3)
            ;+0 = [float] X-axis Rotation (Grad)
            ;+4 = [float] Y-axis Rotation (Grad)
            ;+8 = [float] Z-axis Rotation (Grad)
            ;+16 = [float] X-axis Rotation (Looking)
            ...
            setCoordinates(Pos1, Pos2, Pos3, getPlayerInteriorId())
        addChatMessageEx(0x808080, "[SOBEIT] to " Pos1 ", " Pos2 ", " Pos3 ", interior: " getPlayerInteriorId())
    }
    else if(SubStr(TextChat, 1, 5) = "/skin2") {
        if(SubStr(TextChat, 6) = "")
            return
        RegExMatch(SetPos, "(-?[\d.]*)\s(-?[\d.]*)\s(-?[\d.]*)", Object)
        Count := SubStr(TextChat, 7)
        if(Count >= 0 && Count <= 311)
            setPlayerSkin(Count)
    }
    else if(SubStr(TextChat, 1, 4) = "/obj") {
        if(SubStr(TextChat, 5) = "")
            return
        Object := SubStr(TextChat, 6)
        RegExMatch(Object, "([\d.]*)\s(-?[\d.]*)\s(-?[\d.]*)\s(-?[\d.]*)\s(-?[\d.]*)\s(-?[\d.]*)\s(-?[\d.]*)\s([\d.]*)", Object)
        if(Object1) {
            createObject(Object1, Object2, Object3, Object4, Object5, Object6, Object7, Object8)
            addChatMessageEx(0x808080, "[SOBEIT] " Object1 " on " Object2 ", " Object3 ", " Object4 ", distance:" Object8)
        }
    }
    else if(TextChat = "/guiedit") {
        GuiDrag := 1
        toggleCursor(1)
        text_guiedit := TextCreate("Verdana", 7, true, false, 220, 300, 0xFFFFFFFF,"        USE YOUR MOUSE FOR CHANGING POSITION OF SOBEIT ELEMENTS`nCLICK LEFT MOUSE BUTTON AND DRAG ELEMENT TO PLACE WHERE YOU WANT", true, true)
    }
    else if(TextChat = Command1 && TextChat != "" && TextChat != " ") {         
        goto H1
    }
    else if(TextChat = Command2 && TextChat != "" && TextChat != " ") {         
        goto H2
    }
    else if(TextChat = Command3 && TextChat != "" && TextChat != " ") {         
        goto H3
    }
    else if(TextChat = Command4 && TextChat != "" && TextChat != " ") {         
        goto H4
    }
    else if(TextChat = Command5 && TextChat != "" && TextChat != " ") {         
        goto H5
    }
    else if(TextChat = Command6 && TextChat != "" && TextChat != " ") {         
        goto H6
    }
    else if(TextChat = Command7 && TextChat != "" && TextChat != " ") {         
        goto H7
    }
    else if(TextChat = Command8 && TextChat != "" && TextChat != " ") {         
        goto H8
    }
    else if(TextChat = Command9 && TextChat != "" && TextChat != " ") {         
        goto H9
    }
    else if(TextChat = Command10 && TextChat != "" && TextChat != " ") {         
        goto H10
    }    
    else if(TextChat = Command11 && TextChat != "" && TextChat != " ") {         
        goto H11
    } 
    else if(TextChat = Command12 && TextChat != "" && TextChat != " ") {         
        goto H12
    } 
    else if(TextChat = Command13 && TextChat != "" && TextChat != " ") {         
        goto H13
    } 
    else if(TextChat = Command14 && TextChat != "" && TextChat != " ") {         
        goto H14
    } 
    else if(TextChat = Command15 && TextChat != "" && TextChat != " ") {         
        goto H15
    } 
}
return
...
if (!GuiDrag)
    return
MouseGetPos, MX, MY
MX := (800 * MX/A_ScreenWidth)
MY := (600 * MY/A_ScreenHeight)
if (MX > text_hp_x and MY > text_hp_y) and (MX < text_hp_x+18 and MY < text_hp_y+10) {
    text_hp_dif_x := MX - text_hp_x
    text_hp_dif_y := MY - text_hp_y
    Loop {
        if(GetKeyState("LButton", "P")) {
            MouseGetPos, MX, MY
            text_hp_x := SubStr((800 * MX/A_ScreenWidth) - text_hp_dif_x, 1, 5)
            text_hp_y := SubStr((600 * MY/A_ScreenHeight) - text_hp_dif_y, 1, 5)
            TextSetPos(text_hp, text_hp_x, text_hp_y)
            if (EditInGameGuiopen) {
                GuiControl, EditInGameGui:, text_hp_x, %text_hp_x%
                GuiControl, EditInGameGui:, text_hp_y, %text_hp_y%
            }
        }
        else
            break
...
else if (MX > text_coord_x and MY > text_coord_y) and (MX < text_coord_x+180 and MY < text_coord_y+25) {
    text_coord_dif_x := MX - text_coord_x
    text_coord_dif_y := MY - text_coord_y
    Loop {
        if(GetKeyState("LButton", "P")) {
            MouseGetPos, MX, MY
            text_coord_x := SubStr((800 * MX/A_ScreenWidth) - text_coord_dif_x, 1, 5)
            text_coord_y := SubStr((600 * MY/A_ScreenHeight) - text_coord_dif_y, 1, 5)
            TextSetPos(text_coord, text_coord_x, text_coord_y)
            if (EditInGameGuiopen) {
                GuiControl, EditInGameGui:, text_coord_x, %text_coord_x%
                GuiControl, EditInGameGui:, text_coord_y, %text_coord_y%
            }
        }
        else
            break
...
else if (MX > text_cheats_x and MY > text_cheats_y) and (MX < text_cheats_x+100 and MY < text_cheats_y+90) {
    text_cheats_dif_x := MX - text_cheats_x
    text_cheats_dif_y := MY - text_cheats_y
    Loop {
        if(GetKeyState("LButton", "P")) {
            MouseGetPos, MX, MY
            text_cheats_x := SubStr((800 * MX/A_ScreenWidth) - text_cheats_dif_x, 1, 5)
            text_cheats_y := SubStr((600 * MY/A_ScreenHeight) - text_cheats_dif_y, 1, 5)
            TextSetPos(text_cheats, text_cheats_x, text_cheats_y)
            if (EditInGameGuiopen) {
                GuiControl, EditInGameGui:, text_cheats_x, %text_cheats_x%
                GuiControl, EditInGameGui:, text_cheats_y, %text_cheats_y%
            }
        }
        else
            break
...
else if (MX > text_time_x and MY > text_time_y) and (MX < text_time_x+115 and MY < text_time_y+12) {
    text_time_dif_x := MX - text_time_x
    text_time_dif_y := MY - text_time_y
    Loop {
        if(GetKeyState("LButton", "P")) {
            MouseGetPos, MX, MY
            text_time_x := SubStr((800 * MX/A_ScreenWidth) - text_time_dif_x, 1, 5)
            text_time_y := SubStr((600 * MY/A_ScreenHeight) - text_time_dif_y, 1, 5)
            TextSetPos(text_time, text_time_x, text_time_y)
            if (EditInGameGuiopen) {
                GuiControl, EditInGameGui:, text_time_x, %text_time_x%
                GuiControl, EditInGameGui:, text_time_y, %text_time_y%
            }
        }
        else
            break
...
~Escape::
TextDestroy(text_guiedit)
GuiDrag := 0
return

EditInGameGuiGuiClose:
    Gui, EditInGameGui: Submit, NoHide
    Gui, EditInGameGui: Destroy
    EditInGameGuiopen := 
    TextSetPos(text_hp, text_hp_x, text_hp_y)
    TextSetPos(text_coord, text_coord_x, text_coord_y)
    TextSetPos(text_cheats, text_cheats_x, text_cheats_y)
    TextSetPos(text_time, text_time_x, text_time_y)
    TextUpdate(text_hp, text_hp_font, text_hp_size, true, false)
    TextUpdate(text_coord, text_coord_font, text_coord_size, true, false)
    TextUpdate(text_cheats, text_cheats_font, text_cheats_size, true, false)
    TextUpdate(text_time, text_time_font, text_time_size, true, false)   
return
...
EditInGameGui:
    ...
    EditInGameGuiopen := 1
    WinSet, Transparent, %Transparent%
    Gui, EditInGameGui: color, 000000
    Gui, EditInGameGui: Margin, 0, 0
    Gui, EditInGameGui: Font, S7 CDefault Bold, Arial
    Gui, EditInGameGui: Add, Text, x5 y5 cFFFFFF, %A_Space%                 Coord X      CoordY       Font                              Size            Color           Text
    Gui, EditInGameGui: Add, Text, x5 y27 cFFFFFF, Health
    Gui, EditInGameGui: Add, Edit, x50 y25 w35 h18 Limit3 Center vtext_hp_x, %text_hp_x%
    Gui, EditInGameGui: Add, Edit, x100 y25 w35 h18 Limit3 Center vtext_hp_y, %text_hp_y%
    FontNumber := FontNumber(text_hp_font)
    Gui, EditInGameGui: Add, DropDownList, x150 y25 w70 Center vtext_hp_font Choose%FontNumber%, %FONT1%|%FONT2%|%FONT3%|%FONT4%
    Gui, EditInGameGui: Add, Edit, x235 y25 w35 h18 Limit2 Center vtext_hp_size, %text_hp_size%
    Gui, EditInGameGui: Add, Edit, x285 y25 w40 h18 Limit6 Center vtext_hp_color, %text_hp_color%
    Gui, EditInGameGui: Add, Text, x340 y27 cFFFFFF, 100
    Gui, EditInGameGui: Add, Text, x5 y47 cFFFFFF, Coord
    Gui, EditInGameGui: Add, Edit, x50 y45 w35 h18 Limit3 Center vtext_coord_x, %text_coord_x%
    Gui, EditInGameGui: Add, Edit, x100 y45 w35 h18 Limit3 Center vtext_coord_y, %text_coord_y%
    FontNumber := FontNumber(text_coord_font)
    Gui, EditInGameGui: Add, DropDownList, x150 y45 w70 Center vtext_coord_font Choose%FontNumber%, %FONT1%|%FONT2%|%FONT3%|%FONT4%
    Gui, EditInGameGui: Add, Edit, x235 y45 w35 h18 Limit2 Center vtext_coord_size, %text_coord_size%
    Gui, EditInGameGui: Add, Edit, x285 y45 w40 h18 Limit6 Center vtext_coord_color, %text_coord_color%
    Gui, EditInGameGui: Add, Text, x340 y47 cFFFFFF, 241.000 241.000 241.000 6  
    Gui, EditInGameGui: Add, Text, x5 y67 cFFFFFF, Cheats
    Gui, EditInGameGui: Add, Edit, x50 y65 w35 h18 Limit3 Center vtext_cheats_x, %text_cheats_x%
    Gui, EditInGameGui: Add, Edit, x100 y65 w35 h18 Limit3 Center vtext_cheats_y, %text_cheats_y%
    FontNumber := FontNumber(text_cheats_font)
    Gui, EditInGameGui: Add, DropDownList, x150 y65 w70 Center vtext_cheats_font Choose%FontNumber%, %FONT1%|%FONT2%|%FONT3%|%FONT4%
    Gui, EditInGameGui: Add, Edit, x235 y65 w35 h18 Limit2 Center vtext_cheats_size, %text_cheats_size%
    ;Gui, EditInGameGui: Add, Edit, x285 y65 w35 h18 Limit6 Center vtext_cheats_color, %text_cheats_color%
    Gui, EditInGameGui: Add, Text, x340 y67 cFFFFFF, Wallhack: Activated
    FormatTime, TimeNow, , dd.MM.yyyy HH:mm:ss
    Gui, EditInGameGui: Add, Text, x5 y87 cFFFFFF, Time
    Gui, EditInGameGui: Add, Edit, x50 y85 w35 h18 Limit3 Center vtext_time_x, %text_time_x%
    Gui, EditInGameGui: Add, Edit, x100 y85 w35 h18 Limit3 Center vtext_time_y, %text_time_y%
    FontNumber := FontNumber(text_time_font)
    Gui, EditInGameGui: Add, DropDownList, x150 y85 w70 Center vtext_time_font Choose%FontNumber%, %FONT1%|%FONT2%|%FONT3%|%FONT4%
    Gui, EditInGameGui: Add, Edit, x235 y85 w35 h18 Limit2 Center vtext_time_size, %text_time_size%
    Gui, EditInGameGui: Add, Edit, x285 y85 w40 h18 Limit6 Center vtext_time_color, %text_time_color%
    Gui, EditInGameGui: Add, Text, x340 y87 cFFFFFF, %TimeNow%
    Gui, EditInGameGui: Add, Button, x335 y107 h20 w100 gDEFAULT,  DEFAULT
    Gui, EditInGameGui: Add, Text, x50 y107 cFFFFFF, Save - close this window`n/guiedit - use INGAME EDITOR
    
    Gui, EditInGameGui: Font, S9 CDefault Bold, Arial    
    Gui, EditInGameGui: Show, w480 h135 , %ScriptName%
return

DEFAULT:
text_hp_x := 718
text_hp_y := 90
text_hp_font := "Verdana"
text_hp_size := 6
text_hp_color := "FFFF00"
text_coord_x := 52 
text_coord_y := 570
text_coord_font := "Verdana"
text_coord_size := 6
text_coord_color := "FFFFFF"
text_cheats_x := 180
text_cheats_y := 480
text_cheats_font := "Verdana"
text_cheats_size := 6
text_time_x := 180
text_time_y := 460
text_time_font := "Verdana"
text_time_size := 8
text_time_color := "FFFF00"
TextSetPos(text_hp, text_hp_x, text_hp_y)
TextSetPos(text_coord, text_coord_x, text_coord_y)
TextSetPos(text_cheats, text_cheats_x, text_cheats_y)
TextSetPos(text_time, text_time_x, text_time_y)
...
NumberOfControl := SubStr(A_GuiControl, 0)
GuiControlGet, EditPos, Pos, HK%NumberOfControl%
if (!EditPos)
    GuiControlGet, EditPos, Pos, Command%NumberOfControl%
if (Control = 1) {
    HK%NumberOfControl% := ""
    GuiControl, , HK%NumberOfControl%,
    GuiControl, Hide, HK%NumberOfControl%
    if (!EnableEdit%NumberOfControl%) {
        Gui, Add, Edit, x105 y%EditPosY% w90 h20 vCommand%NumberOfControl%,
        EnableEdit%NumberOfControl% := 1
    }
    else
        GuiControl, Show, Command%NumberOfControl%
}
else if (Control = 2) {
    
    Command%NumberOfControl% := ""
    GuiControl, , Command%NumberOfControl%, %A_Space% 
    GuiControl, Hide, Command%NumberOfControl%
    if (!EnableHotKey%NumberOfControl%) {
        Gui, Add, HotKey, x105 y%EditPosY% w90 h20 vHK%NumberOfControl%,
        EnableHotKey%NumberOfControl% := 1
    }
    else
        GuiControl, Show, HK%NumberOfControl%
}
return
...
GetAdminList(AllAdminList) {
    AdminCount := 0
    Loop, %AdminsAtSum% {
		RegExMatch(AllAdminList, ".*" A_Index "\s*(\w*\_\w*).*", Admin%A_Index%)
	}
    
    Loop, %AdminsAtSum% {
        IsAdminOnline%A_Index% := getPlayerIdByName(Admin%A_Index%1)
        if (IsAdminOnline%A_Index% != -1) {
            if(A_Index <= AdminsAtSum - 6AdminData1 - 5AdminData1 - 4AdminData1 - 3AdminData1 - 2AdminData1 - 1AdminData1)
                color := "{" 7AdminData2 "}"
            else if(A_Index <= AdminsAtSum - 5AdminData1 - 4AdminData1 - 3AdminData1 - 2AdminData1 - 1AdminData1)
                color := "{" 6AdminData2 "}"
            else if(A_Index <= AdminsAtSum - 4AdminData1 - 3AdminData1 - 2AdminData1 - 1AdminData1)
                color := "{" 5AdminData2 "}"
            else if(A_Index <= AdminsAtSum - 3AdminData1 - 2AdminData1 - 1AdminData1)
                color := "{" 4AdminData2 "}"
            else if(A_Index <= AdminsAtSum - 2AdminData1 - 1AdminData1)
                color := "{" 3AdminData2 "}"
            else if(A_Index <= AdminsAtSum - 1AdminData1)
                color := "{" 2AdminData2 "}"
            else if(A_Index <= AdminsAtSum)
                color := "{" 1AdminData2 "}"
            AdminList := AdminList color Admin%A_Index%1 "{33FF00}   " IsAdminOnline%A_Index% "{FFFFFF}`n"
            AdminCount := AdminCount + 1
        }
    }
    List := "{FF0000}Admins Online: " AdminCount "`n" AdminList
    return List
}

AntiAdminAFKCheck(Text) {
    RegExMatch(Text, "Администратор \w*\_\w*\[\d\d?\d?\]\:\s(.*)", Text)
    if (!Text1)
        return 0
    RegExMatch(Text1, "(.*?В?в?ы тут.*)",Text1)
    if (!Text11)
        return 0
    random, random_answer, 0, 5
    random, sleep, 3000, 5000
    addChatMessageEx(0x808080, "[SOBEIT] Автоответ " sleep " с. Текст: " random_answer)
    if (random_answer = 0)
        answer := "/n Здесь"
    if (random_answer = 1)
        answer := "Да."
...
editHUD() {
setHUDValue("HealthX", 500)
setHUDValue("HealthY", 250.0)

setHUDValue("HealthWidth", 150)
setHUDValue("HealthHeight", 7.0)
setHUDValue("HealthBorder", 1)
setHUDValue("HealthColor", 72)

setHUDValue("MoneyX", 500.0)
setHUDValue("MoneyY", 330.0)
setHUDValue("MoneyColor", 22)

setHUDValue("RadarX", 50.0)
setHUDValue("Radar-Height-XPos", 300.0)
...
if (!isPlayerInAnyVehicle())
    return
if (!Turbo) {
    WriteFloat(hGTA, dwAddr + 0x94, 0.1) ;Grip Lvl
    Turbo := 1
}
else {
    WriteFloat(hGTA, dwAddr + 0x94, 1) ;Grip Lvl
    Turbo := 0
}
return
...
if (!isPlayerInAnyVehicle())
    return
writeFloat(hGTA, dwAddr + 0x44, 0)
writeFloat(hGTA, dwAddr + 0x48, 0)
writeFloat(hGTA, dwAddr + 0x4c, 0)
return
...
H6:
writeMemory(hGTA, 0xB6F0DC, 3, 4, "int")
dwAddr := readDWORD(hGTA, ADDR_VEHICLE_PTR)
writeFloat(hGTA, dwAddr + 0x50, 0.1)
return

H7:
getPlayerPos(CoordX, CoordY, CoordZ)
Interior := getPlayerInteriorId()
Rotation := GetCameraRotation()
To_Y := 0
To_X := 0
if (Rotation > -0.75) and (Rotation < 0.75)
    To_Y := 1
else if (Rotation > 0.75) and (Rotation < 2.25)
    To_X := 1
else if (Rotation > -2.25) and (Rotation < -0.75)
    To_X := -1
else if (Rotation > 2.25) or (Rotation < -2.25)
    To_Y := -1
setCoordinates(CoordX+To_X, CoordY+To_Y, CoordZ, Interior)
Return
...
writefloat(hGTA, vehPTR + 1216, 200)
return
...
~$vk01::
{
    ...
    While GetKeyState("vk01", "P") {
        ...
        if (AimVersion = 1) {
            ...
            if (CPed) {
                sleep 1
                dwAddress := readDWORD(hGTA, CPed + 0x14)
                MyPosX := readFloat(hGTA, dwAddress + 0x30)
                MyPosY := readFloat(hGTA, dwAddress + 0x34)
                MyPosZ := readFloat(hGTA, dwAddress + 0x38)
                
                RotAngle := readFloat(hGTA, CPed + 0x558)
                ...
                writeFloat(hGTA, dwAddress + 0x30, Xwping)
                writeFloat(hGTA, dwAddress + 0x34, Ywping)
                writeFloat(hGTA, dwAddress + 0x38, Zwping)
                ; addChatMessageEx(0xFFFFFF, MyPosX " " MyPosY "" MyPosZ " " RotAngle)
            }
        }
        else {
            dwAddress := readDWORD(hGTA, Ped + 0x14)
            B := readFloat(hGTA, dwAddress + 0x34) - readFloat(hGTA, ADDR_POSITION_Y)
            A := readFloat(hGTA, dwAddress + 0x30) - readFloat(hGTA, ADDR_POSITION_X)
            Angle := atan2(B,A)
            CameraRotate := (-Angle-1.570796)+0.051
            writeMemory(hGTA, 0xB6F258, CameraRotate, 4, "float")
        }
    }
}
return
